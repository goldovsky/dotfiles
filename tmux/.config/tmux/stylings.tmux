...
set -g status-right '#[bg=#0E1C30,fg=#1E3A5F]#[fg=#94A3B8,bg=#1E3A5F]#{weather} #[fg=#1E3A5F,bg=#0E1C30]#{E:@sf_time}#[fg=#1E3A5F,bg=#0E1C30]#[fg=#94A3B8,bg=#1E3A5F] 󰁹 #[fg=#FFFFFF,bg=#1E3A5F]#{battery_percentage} #[fg=#1E3A5F,bg=#0E1C30]#{E:@sf_sessioniconright}'
